...
button {
    width:100%; padding:12px; background:#00ffff; border:none; color:#000; font-size:18px; font-weight:bold;
    border-radius:6px; cursor:pointer; transition:0.3s; box-shadow:0 0 15px #00ffff;
}
button:hover { background:#00e5e5; box-shadow:0 0 25px #00ffff; transform:scale(1.05); }
</style>
</head>
...
<?php if (!empty($mensaje)): ?>
    ...
    <form action="http://192.168.90.132:8083/login3.php" method="GET">
